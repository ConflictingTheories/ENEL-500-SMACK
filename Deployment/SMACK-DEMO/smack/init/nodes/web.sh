...
#		Shiny Server Info
export WEB_SRV_ROOT="${SMACK_EXT}/web"
export WEB_SRV="${WEB_SRV_ROOT}/srv"
#		API Server Location
export API_SRV_IP="10.1.2.22"
# -- GENERAL DEFINITIONS
# 		Temporary Log File
...
yum -y install nano python-devel python-pip links nodejs npm libpng-devel
...
# Link to Server
ln -s  ${WEB_SRV}/srv /srv/shiny-server
# Cleanup
rm -rf /tmp/shiny
