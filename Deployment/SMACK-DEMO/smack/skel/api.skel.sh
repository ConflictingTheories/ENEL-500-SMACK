...
#		Username
export OS_USERNAME="_%%_OS_USERNAME_%%_"
#		Password
export OS_PASSWORD="_%%_OS_PASSWORD_%%_"
#		Project name
export OS_PROJECT_NAME="_%%_OS_PROJECT_NAME_%%_"
#		Tenant Name
export OS_TENANT_NAME="_%%_OS_TENANT_NAME_%%_"
#		Keystone URL
export OS_AUTH_URL="_%%_OS_AUTH_URL_%%_"
#		Zone
export OS_ZONE="_%%_OS_ZONE_%%_"
#		Region
export OS_REGION="_%%_OS_REGION_%%_"
#		Swift URl
export OS_SWIFT_URL="_%%_OS_SWIFT_URL_%%_"
#		Account ID
export OS_ACCT_ID="_%%_OS_ACCT_ID_%%_"

# -- API SPECIFIC DEFINITIONS
#		Node JS Server Root
export API_SRV="_%%_API_SRV_%%_"
...
#!/bin/bash
at -f ${SMACK_EXT}/api/start-api.sh
EOF
#		Log Report
